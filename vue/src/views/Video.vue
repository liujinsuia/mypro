<template>
  <div class="video">
    ...
    <el-dialog :visible.sync="dialogVisible">
      ...
      <span
        class="barrage-body"
        :class="{move:barrageSend.move,pause:barrageSend.pause,play:barrageSend.play}"
      >{{barrageSend.value}}</span>
      <input class="input-barrage" v-model="barrageSend.input" type="text">
      <button @click="SendBarrage" class="send">发射</button>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      cartoon: [
        {
          title: "漫画01 - 乌鸦王的崛起",
          img: "http://127.0.0.1:3000/ymy/cartoon/cartoon1.jpg",
          url: "http://127.0.0.1:3000/ymy/cartoon/01.pdf"
        },
        {
          title: "漫画02 - 风暴的秘密",
          img: "http://127.0.0.1:3000/ymy/cartoon/cartoon2.jpg",
          url: "http://127.0.0.1:3000/ymy/cartoon/02.pdf"
        },
        {
          title: "漫画03 - 君冠城的陨落",
          img: "http://127.0.0.1:3000/ymy/cartoon/cartoon3.jpg",
          url: "http://127.0.0.1:3000/ymy/cartoon/03.pdf"
        },
        {
          title: "漫画04 - 奥菲娅",
          img: "http://127.0.0.1:3000/ymy/cartoon/cartoon4.jpg",
          url: "http://127.0.0.1:3000/ymy/cartoon/04.pdf"
        }
      ],
      first: [],
      url: {
        gameimg:
          "http://127.0.0.1:3000/api/getgameimg?sqlname=gameimg&size=12&num=",
        playerimg:
          "http://127.0.0.1:3000/api/getgameimg?sqlname=playerimg&size=12&num="
      },
      btnActive: false,
      spanActive: -1,
      dialogVisible: false,
      ...
      homelist: [
        {
          title: "视频",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/1.png"
        },
        {
          title: "官方漫画",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/2.png"
        },
        {
          title: "游戏截图",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/3.png"
        },
        {
          title: "玩家作品",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/4.png"
        },
        {
          title: "壁纸",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/5.png"
        },
        {
          title: "素材",
          url: "",
          pic: "http://127.0.0.1:3000/ymy/video_img/6.png"
        }
      ]
    };
  },
  ...
  methods: {
    ...
    play(item) {
      ...
      console.log(this.playerOptions.sources[0].src), this.barrage();
    },
    barrage() {
...
body {
  background: #11041e
    url(http://heroes.nos.netease.com/1/images/common/bg_r.jpg) repeat 0 0;
...
.video {
  background: #0d0119
    url(http://127.0.1:3000/ymy/video_img/1_images_media_v2_bg_1.jpg) top center
    no-repeat;
  margin: 0;
  padding: 0;
  margin-top: 40px;
...
.video .vjs-custom-skin > .video-js .vjs-big-play-button {
  ...
  border-radius: 50%;
  border: 0;
  background-image: url(http://127.0.1:3000/ymy/video_img/video_play.png);
